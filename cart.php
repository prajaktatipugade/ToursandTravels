   ...
   <table>
      ...
      <tbody>
         ...
         <tr class="table-bottom">
            ...
            <td><a href="cart.php?delete_all" onclick="return confirm('are you sure you want to delete all?');" class="delete-btn"> <i class="material-icons" style="color:white">shopping_cart</i></td>
         </tr>
